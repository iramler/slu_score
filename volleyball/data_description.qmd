...
The data set contains 334 rows and 15 columns. Each row represents a team at the NCAA Division 1 level from the 2022-2023 season.
...
\| aces_per_set \| the average amount of balls served that immediately win a point per set \|
...
\| opp_hitting_pctg \| the average hitting pctg of the teams opponent per set \|

\| service_aces \| amount of serves that directly led to a point not including errors by the opponent \|
