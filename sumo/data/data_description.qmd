...
How can we transform sumo wrestling data to find the most relevant cases? What variables can be created from existing data in the data set? Which wrestlers the most successful careers since 1957?

## References

Sumo Reference - Alexander Nitschke
