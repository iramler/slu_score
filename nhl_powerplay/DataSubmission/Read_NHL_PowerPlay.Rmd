---
title: "Reading NHL Power Play Data"
author: Abby Hustler
...
powerplay_data<- powerplay_data|> mutate(Conference = if_else(team %in% vec_eastern,
                                            true = "Eastern",
                                            false = "Western"))
```

```{r}
write.csv(powerplay_data,"NHL_PowerPlay2022.csv")
```
